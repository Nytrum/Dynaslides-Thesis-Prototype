var _order=1;
module.exports.tXml = function(b){function c(){for(var g=[];b[a];){if(60==b.charCodeAt(a)){if(47===b.charCodeAt(a+1)){a=b.indexOf(">",a);break}else if(33===b.charCodeAt(a+1)){if(45==b.charCodeAt(a+2)){for(;62!==b.charCodeAt(a)||45!=b.charCodeAt(a-1)||45!=b.charCodeAt(a-2)||-1==a;)a=b.indexOf(">",a+1);-1===a&&(a=b.length)}else for(a+=2;62!==b.charCodeAt(a);a++);a++;continue}else if(63===b.charCodeAt(a+1)){a=b.indexOf(">",a);a++;continue}a++;for(var d=a;-1==="\r\n\t>/= ".indexOf(b[a]);a++);for(var f=b.slice(d,a),k=
